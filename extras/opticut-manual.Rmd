...
yy <- y[-(1:5),]
#o <- opticut(y ~ x, data=df, strata=g, dist="binomial")
object <- opticut(yy ~ x, data=df, strata=g, dist="poisson")
summary(object)
...
Todo:
- use notation: j=1...p & s=1...S, or q=1...p & j=1...S
- implement test cases for lm/glm
- write internal function (.calibrate)
- implement user interface: calibrate, calibrate.opticut(object, ynew, xnew, ...)
- add beta, ZI cases (ZI: inits!) [drop all the 1-species models!]

---
title: 'opticut: likelihood-based optimal partitioning for indicator species analysis (supporting information)'
...
## Percent cover data: Binomial, Beta distribution, and ordinal
...
Finally, here is how an ordered logistic model can be fit to a single species.
Note that number of ordered categories and baseline levels might change from one species to the other, therefore this distribution is not available for multiple species.
...
#oven$veg[oven$pforest >= 0.5 & oven$pdecid >= 0.6] <- "decid"
#oven$veg[oven$pforest >= 0.5 & oven$pdecid < 0.4] <- "conif"

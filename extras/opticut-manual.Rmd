...
* `"ordered"`: response measured on ordinal scale, e.g. ordinal vegetation cover (only available for single species because ordinal levels often do not match actoss different species thus leading to different intercept terms);
...
plot(dol0, show_I=FALSE, show_S=FALSE)
plot(dol1, show_I=FALSE, show_S=FALSE)
par(opar)
```

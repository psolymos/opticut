...
Bootstrap based partitioning uncertainty: find best partition with bootstrap:
parametric or non-parametric? This is kind of redundant (w gives this well
for large sample). It is interesting for small data sets.

Bootstrap based CI on I: use best partition to get CI (parametric or non-parametric?): CI around mu0, mu1, I

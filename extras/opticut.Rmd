...
`allComb` returns a 'contrast' matrix corresponding to
...
`modelComb` this takes a classification vector with at least 2 levels
...
r1 <- opticut(Y ~ x2, strata=Z[,1:4], dist="poisson", comb="rank")

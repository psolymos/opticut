...
summary(uc1$uncertainty[[1]])
summary(uc2$uncertainty[[1]])
summary(uc3$uncertainty[[1]])

plot(density(uc1$uncertainty[[1]]$I), ylim=c(0,7))
lines(density(uc2$uncertainty[[1]]$I), col=2)
lines(density(uc3$uncertainty[[1]]$I), col=4)
...
system.time(uncertainty(o, type="boot", B=200))
system.time(uncertainty(o, type="boot", B=200, cl=cl))

system.time(uncertainty(o, type="multi", B=200))
system.time(uncertainty(o, type="multi", B=200, cl=cl))
stopCluster(cl)
```

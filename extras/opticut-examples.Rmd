...
function(b1=0.5, b2=0, b3=0, b4=0, mu0=10, n=100, pos=TRUE)
{
    ...
    if (pos)
        Y[Y < 0] <- 0
    out <- data.frame(Y=Y, h0=h0, h1=h1, x=x,
...
dat <- oc_sim_K2(b1=0.5, b2=0, b3=0, b4=0, mu0=5, n=100)
plot(Y ~ x, dat)
...
## Noise
dat <- oc_sim_K2(b1=0.9, b2=0, b3=1, b4=0, mu0=5, n=100)
plot(Y ~ x, dat)
m0 <- opticut(Y ~ 1, dat, strata=h1)
m1 <- opticut(Y ~ x, dat, strata=h1)
m0$species[[1]]
...
## Noise + Confounding
dat <- oc_sim_K2(b1=0.9, b2=0.5, b3=1, b4=0, mu0=5, n=100)
plot(Y ~ x, dat)
m0 <- opticut(Y ~ 1, dat, strata=h1)
m1 <- opticut(Y ~ x, dat, strata=h1)
m0$species[[1]]
